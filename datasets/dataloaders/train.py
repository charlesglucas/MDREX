...
def get_dataloaders_train(
    ...
    synthetic_coords_sampler_train = CoordsSamplerTransform(
        name="uniform",
        deterministic=False,
        adaptive=use_adaptive,
        symmetric_flux=symmetric_flux_train,
        n_min=n_min,
        n_max=n_max,
        size=obj_size,
        crop=crop,
    ...
    synthetic_coords_sampler_val = CoordsSamplerTransform(
        name="uniform",
        deterministic=True,
        adaptive=use_adaptive,
        n_min=n_min,
    ...
    transforms_train = [
        ...
        real_coords,
        sources_masker,
        synthetic_coords_sampler_train,
        key_renamer_s,
        rot90_train,
        time_flip_train,
        spatial_flip_train,
