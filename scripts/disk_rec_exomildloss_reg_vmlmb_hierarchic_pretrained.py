...
def main(cfg):
    ...
    cfg_model.use_dataparallel = False # true
    ...
    for k in range(s1):
        for j in range(s2):
            ...
            def fg(x_disc):
                ...
                del im, diff, params, log_likelihood, phi, loss, x_tensor
                return fx, gx
    ...
    np.savez(ROOT / "results/results_hierarchic_ellipse1em5_grid_pretrained.npz", y=y_numpy, x=x_disk_store, x_gt=x_gt_numpy, rmse=RMSE, n_smooth=n_smooth, n_sparse=n_sparse)
