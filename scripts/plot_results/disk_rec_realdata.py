...
def main(cfg):
    ...
    result_file = 'HD_106906-2016-03-28-k1_k2'
    display_titles = {
        "HR_4796": "HR 4796A",
        "RY_lup": "RY Lupi",
        "PDS_70": "PDS 70",
    ...
    data_file = "HD_106906/2016-03-28/IRDIS/k1_k2/data"
    path_data = ROOT / "data/real_data/DISKS_IRDIS_CHARLES" / data_file
    ...
    for k in range(3):
        for j in range(3):
            ...
            sm = nsmooth+k; 
            sp = nsparse+j
            plt.subplot(3,3,h); plt.imshow(np.squeeze(np.mean(x_disk_store[k+2,j+2], axis=0))); plt.title(rf"$(10^{{{sm}}},\, 10^{{{sp}}})$"); plt.colorbar()
